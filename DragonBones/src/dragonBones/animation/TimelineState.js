	...
	_onCrossFrame(frameIndex) {
		...
		if (this._animationState.actionEnabled) {
			const frameOffset =
				...
				this._timelineArray[
					this._timelineData.offset + BinaryOffset.TimelineFrameOffset + frameIndex
				];
				...
				if (this._frameIndex !== frameIndex) {
					...
					if (this._timelineArray !== null) {
						this._frameOffset =
							this._animationData.frameOffset +
							this._timelineArray[
								timelineData.offset + BinaryOffset.TimelineFrameOffset + this._frameIndex
							];
	...
	init(armature, animationState, timelineData) {
		...
		if (this._timelineData !== null) {
			...
			const frameIntOffset =
				...
				this._timelineArray[this._timelineData.offset + BinaryOffset.TimelineFrameValueCount];
			this._valueOffset = this._animationData.frameFloatOffset;
